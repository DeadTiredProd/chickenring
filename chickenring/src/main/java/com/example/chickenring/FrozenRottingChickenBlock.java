...
public class FrozenRottingChickenBlock extends Block {
    public FrozenRottingChickenBlock(Settings settings) {
        super(settings);
    }

    @Override
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, net.minecraft.util.math.random.Random random) {
        // 1) Thaw if we're in a non-snow biome
        ...
        // 2) Or thaw if adjacent to a heat source
