...
public class ChickenRingClient implements ClientModInitializer {
    private static KeyBinding toggleFlightKey1;
    private static KeyBinding spoofCommandBlockKey;
    ...
    public void onInitializeClient() {
        ...
        toggleFlightKey1 = KeyBindingHelper.registerKeyBinding(new KeyBinding(
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            if (toggleFlightKey1.wasPressed()) {
        ...
        spoofCommandBlockKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
        ...
        // Tick listener
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            if (spoofCommandBlockKey.wasPressed()) {
        ...
        BlockEntityRendererFactories.register(ChickenRingMod.FOWL_FORGE_BLOCK_ENTITY,
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (flightEnabled) {
                ...
                if (!player.getAbilities().flying && MinecraftClient.getInstance().options.jumpKey.isPressed()) {
                    player.getAbilities().flying = true;
                    player.sendAbilitiesUpdate();
                }
                // prevent fall damage
