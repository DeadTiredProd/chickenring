...
public class ModFoodComponents {
    ...
    public static final FoodComponent FROZEN_ROTTING_CHICKEN_FOOD = new FoodComponent.Builder()
            ...
            .meat()
                    .build();
    public static final FoodComponent FROZEN_RAW_CHICKEN_FOOD = new FoodComponent.Builder()
            .hunger(6)
            .saturationModifier(0.2f)
            .statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 200, 0), 0.5f)
            .meat()
                    .build();
   public static final FoodComponent FROZEN_COOKED_CHICKEN_FOOD = new FoodComponent.Builder()
            .hunger(6)
            .saturationModifier(0.2f)
            .statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 200, 0), 0.5f)
            .meat()
